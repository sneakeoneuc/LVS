...
.EXAMPLE
    ...
    PS C:\> Run-AzureRunCommand -subscription -ResourceGroup bobprodtesting -VMName bmprodlinux2 -RunShellScripts RunShellScript -pathToScripts C:\GitRepo\CMP-LVSDE-TF-VM\TF\EQBank_Az_LinuxVM_v1\ShellScripts
