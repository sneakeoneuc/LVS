<#
    Purpose: Test the SetupLVSDE.ps1 (one of the pipeline scripts) with Az_WindowsVM_v3.
#>

Describe -Tag 'Az_WindowsVM_v3' "Run Az_WindowsVM_v3 Tests" {

    $script:EditionCode = "Az_WindowsVM_v3"
    #Test name
